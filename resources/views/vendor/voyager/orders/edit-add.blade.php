                                ...
                                @if ($loop->iteration == 1)
                                    <div class="form-group col-md-12">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading"><h5 class="panel-title">Покупки</h5></div>
                                            ...
                                            <table class="table">
                                                ...
                                                @if (isset($purchases) && count($purchases)>0)
                                                    @foreach ($purchases as $v)
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" name="purchases[id][]" value="{{ $v->id }}">
                                                                <input type="text" name="purchases[product_name][]" value="{{ $v->product_name }}">
                                                            </td>
                                                            <td><input type="text" name="purchases[variant_name][]" value="{{ $v->variant_name }}"></td>
                                                            <td><input type="text" name="purchases[sku][]" value="{{ $v->sku }}"></td>
                                                            <td><input type="text" name="purchases[price][]" value="{{ $v->price }}"></td>
                                                            <td><input type="text" name="purchases[amount][]" value="{{ $v->amount }}"></td>
                                                            <td><input type="text" value="{{ $v->amount*$v->price }}"></td>
                                                            <td>
