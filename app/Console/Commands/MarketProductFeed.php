...
class MarketProductFeed extends Command {
    ...
    public function handle() {
        ...
        $view = View::make('feeds.all_products', compact('categories', 'variants', 'date'));
        ...
        \Storage::disk('public')->put($folder.DIRECTORY_SEPARATOR.'yandex.xml', $xml);
